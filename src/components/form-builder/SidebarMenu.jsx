...
const SidebarMenu = () => {
  ...
  return (
    <div className="flex items-center ">
      <div className="border dark:border-black shadow text-center w-[50px] bg-white mx-auto rounded-full">
        <button
          ...
          className={`${
            leftSidebarTool === "fields"
              ...
              : "hover:bg-primary/10"
          } dark:bg-dark dark:text-white w-full font-medium rounded-t-full text-center h-[80px] duration-500 transform`}
        >
        ...
        <button
          ...
          className={`${
            leftSidebarTool === "design"
              ? "bg-primary dark:bg-primary text-white"
              : "hover:bg-primary/10"
          } dark:bg-dark dark:text-white w-full font-medium rounded-b-full text-center h-[80px] duration-500 transform`}
        >
