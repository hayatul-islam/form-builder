  ...
  return (
    <div className="mt-32 bg-gradient-to-b from-[#F7F7F7] to-[#F7F7F7] text-gray-800 flex items-center justify-center ">
      <div className="text-center max-w-4xl px-6 space-y-5 py-5">
        <button className="px-4 py-2 border-2 rounded-full border-white text-black text-[14px] font-medium cursor-auto flex items-center gap-1 justify-center mx-auto">
          <RiDragMove2Fill />
